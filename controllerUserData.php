...
if(count($errors) === 0){
    $encpass = password_hash($password, PASSWORD_BCRYPT); // Encrypt the password
    $code = rand(999999, 111111); // Generate random verification code
    $status = "notverified";
    ...
    if($data_check){
        // Include the send_mail.php file to send a welcome email
        ...
        if(mail($email, $subject, $message, $sender)){
            // Store email and password in session and redirect to OTP verification
...
if(isset($_POST['check-email'])){
    ...
    if(mysqli_num_rows($run_sql) > 0){
        ...
        if($run_query){
            ...
            $headers = "From: shahiprem7890@gmail.com";
